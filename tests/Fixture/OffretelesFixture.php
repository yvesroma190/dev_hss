...
class OffretelesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'prix' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-06-30 08:59:55',
                'modified' => '2020-06-30 08:59:55',
            ],
        ];
        parent::init();
    }
